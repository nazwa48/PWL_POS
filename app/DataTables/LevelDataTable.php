             ...
             ->addColumn('action', function ($level) {
                 return '
                     <div class="btn-group" role="group">
                         <a href="' . route('/level/edit', ['id' => $level->level_id]) . '" class="btn btn-sm btn-warning mr-2">
                             <i class="fas fa-edit"></i>
                         </a>
                         <a href="' . route('/level/delete', ['id' => $level->level_id]) . '" class="btn btn-sm btn-danger" onclick="return confirm(\'Are you sure want to delete?\')">
