...
<div class="card card-outline card-primary">
    ...
    <div class="card-body"> 
        ...
        <a href="{{ url('users') }}" class="btn btn-sm btn-default mt- 2">Kembali</a>
        @else
        <form method="POST" action="{{ url('/users/'.$user->user_id) }}" class="form-horizontal">
            @csrf
            {{ method_field('PUT') }}
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    ...
                    <a class="btn btn-sm btn-default ml-1" href="{{ url('users') }}">Kembali</a>
                </div>
            </div>
        </form> @endempty
    </div>
